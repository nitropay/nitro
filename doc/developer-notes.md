...
NitroPay Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as NitroPay Core, where everyone uses
...
pay attention to for reviewers of NitroPay Core code.

General NitroPay Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: NitroPay Core uses tinyformat, which is type safe. Leave them out to avoid confusion
