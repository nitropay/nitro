...
Only requiring some minor changes is nitropay.cpp.
...
Changes to nitropay.cpp
----------------------
nitropay.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
