...
This mechanism has been integrated into Bitcore-Node-NitroPay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/nitropaypay/insight-api-nitropay#web-socket-api](https://github.com/nitropaypay/insight-api-nitropay#web-socket-api)
* API: [https://github.com/nitropaypay/insight-api-nitropay#instantsend-transactions](https://github.com/nitropaypay/insight-api-nitropay#instantsend-transactions)
...
By default, the NitroPay Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the NitroPay Core daemon:
