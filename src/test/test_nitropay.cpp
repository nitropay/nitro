...
#define BOOST_TEST_MODULE NitroPay Test Suite

#include "test_nitropay.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_nitropay_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
