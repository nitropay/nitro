...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("NitroPay Core nitropay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nitropay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nitropay transaction") + "\n" +
              "  nitropay-tx [options] -create [commands]   " + _("Create hex-encoded nitropay transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nitropay transaction
