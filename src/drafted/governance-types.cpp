...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "NitroPayNetwork") type = NitroPayNetwork;
    if(strType == "NitroPayNetworkVariable") type = NitroPayNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == NitroPayNetwork) s = "NitroPayNetwork";
    if(type == NitroPayNetworkVariable) s = "NitroPayNetworkVariable";
