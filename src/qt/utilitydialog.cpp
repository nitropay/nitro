    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("NitroPay Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About NitroPay Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  nitropay-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NitroPay in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NITRO, 0.1 NITRO, 1 NITRO and 10 NITRO -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://nitropaypay.atlassian.net/wiki/display/DOC/PrivateSend\">https://nitropaypay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NitroPay Core is shutting down...") + "<br /><br />" +
