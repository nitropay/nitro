    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("NitroPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NitroPay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nitropay: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About NitroPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about NitroPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NitroPay Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NitroPay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NitroPay addresses"));
    ...
    openAction->setStatusTip(tr("Open a nitropay: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NitroPay Core help message to get a list with possible NitroPay Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("NitroPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NitroPay network", "", count));
    } else {
...
{
    QString strTitle = tr("NitroPay Core"); // default title
