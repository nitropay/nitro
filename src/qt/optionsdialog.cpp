    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("NITRO-light"), QVariant("light"));
    ui->theme->addItem(QString("NITRO-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("NITRO-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("NITRO-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("NITRO-traditional"), QVariant("trad"));
